...
public class Utils {
    ...
    /**
     * 获取日期字符串
     * @param format 日期格式比如：yyyyMMddHHmmss
     * @return
     */
    public static String getDateString(String format) {
        return Utils.getDateString(format, LocalDateTime.now());
    }
     ...
     * @return
     */
    public static String getDateString(String format, LocalDateTime localDateTime) {
     ...
     * @return
     */
    static public Integer getCurrentDate() {
        Date date = new Date();
        String strDateFormat = "yyyyMMdd";
        DateFormat dateFormat = new SimpleDateFormat(strDateFormat);
        String formattedDate= dateFormat.format(date);
        Integer longDate = Integer.parseInt(formattedDate);
        return longDate;
    }
