...
export class IndexComponent implements OnInit {
   ...
   * @param data 分页数据
   */
  validateData(data: Page<VehicleType>): void {
   ...
   * @param vehicleType
   */
  validateVehicleType(vehicleType: VehicleType): void {
    // 必有条件
